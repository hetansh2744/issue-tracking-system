...
// Note: For simplicity, the IDs are handled as strings (User) or int (Issue/Comment)
// and we are including only the minimum required methods for compilation.
...
public:
    ...
    // Default constructor for returning failure/invalid objects
    Comment(int issueId = 0, const std::string& authorId = "", const std::string& text = "")
